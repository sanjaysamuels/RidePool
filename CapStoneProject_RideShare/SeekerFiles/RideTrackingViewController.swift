...
//  
//
//  Created by user206596 on 8/7/22.
//
...
class RideTrackingViewController: UIViewController, MKMapViewDelegate {
    @IBOutlet weak var rideLable: UILabel!
    ...
    let database = Firestore.firestore()
       ...
       func angleFromCoordinate(firstCoordinate: CLLocationCoordinate2D,
                         ...
                         extension RideTrackingViewController : CLLocationManagerDelegate {
   ...
   extension SeekerHomeVC : MKMapViewDelegate {
